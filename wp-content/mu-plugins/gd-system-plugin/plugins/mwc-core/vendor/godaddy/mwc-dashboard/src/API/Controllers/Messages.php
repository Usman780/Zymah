...
class Messages extends AbstractController
{
    ...
    public function getItems()
    {
        ...
        } catch (BaseExceptionHandler $exception) {
    ...
    protected function getMessagesData() : array
    {
        ...
        if ($response->isError() || 200 !== $response->getStatus()) {
            throw new BaseExceptionHandler(__('Could not retrieve remote messages data', 'mwc-dashboard'),
        ...
        if (! ArrayHelper::accessible($messages)) {
            throw new BaseExceptionHandler(__('Remote messages data is invalid', 'mwc-dashboard'), 500);
        }
