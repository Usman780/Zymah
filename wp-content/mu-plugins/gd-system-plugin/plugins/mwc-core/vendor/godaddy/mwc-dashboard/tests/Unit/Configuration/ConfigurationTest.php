...
class ConfigurationTest extends WPTestCase
{
    ...
    public function testExtensionsConfigurationFile()
    {
        ...
        $this->assertSame('https://cdn4.mwc.secureserver.net/mwc-extensions-client/index.js', Configuration::get('mwc_extensions.client.source.url'));
        $this->assertSame('https://cdn4.mwc.secureserver.net/mwc-extensions-client/vendors.js', Configuration::get('mwc_extensions.client.vendors.url'));
        $this->assertSame('https://cdn4.mwc.secureserver.net/mwc-extensions-client/runtime.js', Configuration::get('mwc_extensions.client.runtime.url'));

        $this->assertIsString(Configuration::get('mwc_extensions.assets.admin.url'));
