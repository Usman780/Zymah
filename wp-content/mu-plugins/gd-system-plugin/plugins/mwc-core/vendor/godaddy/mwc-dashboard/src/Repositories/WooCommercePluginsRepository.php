...
class WooCommercePluginsRepository
{
    ...
    /**
     * Gets plugin data for a locally installed non-managed plugin by its name.
     *
     * @param string $pluginName
     * @return array
     */
    public static function getPluginDataByName(string $pluginName) : array
    {
        $pluginsData = ArrayHelper::where(static::getLocalWooPluginsData(), function ($wooCommercePluginData) use ($pluginName) {
            return $pluginName === $wooCommercePluginData['Name'];
        });
