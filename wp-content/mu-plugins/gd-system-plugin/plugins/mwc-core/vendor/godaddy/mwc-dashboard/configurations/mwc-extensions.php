...
return [
    ...
    /*
     *--------------------------------------------------------------------------
     * MWC Extensions Client
     *--------------------------------------------------------------------------
     *
     * The below information stores values related to the client side of the extensions page.
     * See https://github.com/gdcorp-partners/mwc-extensions-client for more details
     */
    'client' => [
        'runtime' => [
            'url' => 'https://cdn4.mwc.secureserver.net/mwc-extensions-client/runtime.js',
        ],
        'vendors' => [
            'url' => 'https://cdn4.mwc.secureserver.net/mwc-extensions-client/vendors.js',
        ],
        'source' => [
            'url' => 'https://cdn4.mwc.secureserver.net/mwc-extensions-client/index.js',
        ],
    ],
