...
{
    /**
     * Tests the getPluginDataByName() method.
     *
     * @covers \GoDaddy\WordPress\MWC\Dashboard\Repositories\WooCommercePluginsRepository::getPluginDataByName()
     * @throws \Exception
     */
    public function testGetPluginDataByName()
    {
        ...
        $this->assertSame($testData['testwooplugin/testwooplugin.php'], WooCommercePluginsRepository::getPluginDataByName('Test Woo Plugin'));
        $this->assertSame($testData['woocommerce-memberships-mailchimp/woocommerce-memberships-mailchimp.php'], WooCommercePluginsRepository::getPluginDataByName('MailChimp for WooCommerce Memberships'));
        $this->assertSame([], WooCommercePluginsRepository::getPluginDataByName('Another plugin'));
    }
