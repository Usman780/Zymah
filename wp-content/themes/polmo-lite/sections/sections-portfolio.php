<?php 
$jeweltheme_polmo_portfolio_title = get_theme_mod('jeweltheme_polmo_portfolio_title',__('<span>Featured</span> Projects','jeweltheme_polmo'));
$jeweltheme_polmo_portfolio_desc = get_theme_mod('jeweltheme_polmo_portfolio_desc',__('Suppose then that such rings were produced in a medium without friction as the ether is believed to be, they would be permanent structures with a variety of properties.','jeweltheme_polmo'));
$jeweltheme_polmo_portfolio_posts = get_theme_mod('jeweltheme_polmo_portfolio_posts',__('8','jeweltheme_polmo'));
?>
...
<?php
$jeweltheme_polmo_sponsors_title = get_theme_mod('jeweltheme_polmo_sponsors_title',__('<span>Our</span> Elite Sponsors','jeweltheme_polmo'));
...
$jeweltheme_polmo_sponsors_url_1 = get_theme_mod('jeweltheme_polmo_sponsors_url_1',__('http://jeweltheme.com','jeweltheme_polmo'));
...
$jeweltheme_polmo_sponsors_url_2 = get_theme_mod('jeweltheme_polmo_sponsors_url_2',__('http://jeweltheme.com','jeweltheme_polmo'));
...
$jeweltheme_polmo_sponsors_url_3 = get_theme_mod('jeweltheme_polmo_sponsors_url_3',__('http://jeweltheme.com','jeweltheme_polmo'));
...
$jeweltheme_polmo_sponsors_url_4 = get_theme_mod('jeweltheme_polmo_sponsors_url_4',__('http://jeweltheme.com','jeweltheme_polmo'));
