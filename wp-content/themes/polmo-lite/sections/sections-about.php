...
//Progress 1
$jeweltheme_polmo_about_us_progress_title_1 = get_theme_mod('jeweltheme_polmo_about_us_progress_title_1',esc_html__('WordPress Plugin Dev','jeweltheme_polmo'));
$jeweltheme_polmo_about_us_progress_percantage_1 = get_theme_mod('jeweltheme_polmo_about_us_progress_percantage_1',esc_html__('89','jeweltheme_polmo'));

//Progress 2
$jeweltheme_polmo_about_us_progress_title_2 = get_theme_mod('jeweltheme_polmo_about_us_progress_title_2',esc_html__('Web Design','jeweltheme_polmo'));
$jeweltheme_polmo_about_us_progress_percantage_2 = get_theme_mod('jeweltheme_polmo_about_us_progress_percantage_2',esc_html__('70','jeweltheme_polmo'));

//Progress 3
$jeweltheme_polmo_about_us_progress_title_3 = get_theme_mod('jeweltheme_polmo_about_us_progress_title_3',esc_html__('PHP Programming','jeweltheme_polmo'));
$jeweltheme_polmo_about_us_progress_percantage_3 = get_theme_mod('jeweltheme_polmo_about_us_progress_percantage_3',esc_html__('60','jeweltheme_polmo'));

// Button
$jeweltheme_polmo_about_us_button_text = get_theme_mod('jeweltheme_polmo_about_us_button_text',esc_html__('Learn More','jeweltheme_polmo'));
$jeweltheme_polmo_about_us_button_url = get_theme_mod('jeweltheme_polmo_about_us_button_url',esc_html__('#','jeweltheme_polmo'));

// Counter 1
$jeweltheme_polmo_about_us_counter_icon_1 = get_theme_mod('jeweltheme_polmo_about_us_counter_icon_1',esc_html__('fa-heart-o','jeweltheme_polmo'));
$jeweltheme_polmo_about_us_counter_number_1 = get_theme_mod('jeweltheme_polmo_about_us_counter_number_1',esc_html__('8,236','jeweltheme_polmo'));
$jeweltheme_polmo_about_us_counter_text_1 = get_theme_mod('jeweltheme_polmo_about_us_counter_text_1',esc_html__('Love Bites','jeweltheme_polmo'));

// Counter 2
$jeweltheme_polmo_about_us_counter_icon_2 = get_theme_mod('jeweltheme_polmo_about_us_counter_icon_2',esc_html__('fa-wifi','jeweltheme_polmo'));
$jeweltheme_polmo_about_us_counter_number_2 = get_theme_mod('jeweltheme_polmo_about_us_counter_number_2',esc_html__('1,203','jeweltheme_polmo'));
$jeweltheme_polmo_about_us_counter_text_2 = get_theme_mod('jeweltheme_polmo_about_us_counter_text_2',esc_html__('Customer Centers','jeweltheme_polmo'));

// Counter 3
$jeweltheme_polmo_about_us_counter_icon_3 = get_theme_mod('jeweltheme_polmo_about_us_counter_icon_3',esc_html__('fa-map-marker','jeweltheme_polmo'));
$jeweltheme_polmo_about_us_counter_number_3 = get_theme_mod('jeweltheme_polmo_about_us_counter_number_3',esc_html__('3,679','jeweltheme_polmo'));
$jeweltheme_polmo_about_us_counter_text_3 = get_theme_mod('jeweltheme_polmo_about_us_counter_text_3',esc_html__('Love Bites','jeweltheme_polmo'));

// Counter 4
$jeweltheme_polmo_about_us_counter_icon_4 = get_theme_mod('jeweltheme_polmo_about_us_counter_icon_4',esc_html__('fa-cogs','jeweltheme_polmo'));
$jeweltheme_polmo_about_us_counter_number_4 = get_theme_mod('jeweltheme_polmo_about_us_counter_number_4',esc_html__('2,310','jeweltheme_polmo'));
$jeweltheme_polmo_about_us_counter_text_4 = get_theme_mod('jeweltheme_polmo_about_us_counter_text_4',esc_html__('Mechanical Cogs','jeweltheme_polmo'));
            ...
            <div class="section-padding">
              <div class="item-no media-left">
                <span class="count text-right">
                  <?php echo esc_html__( "01", "jeweltheme_polmo" ); ?>
                </span>
              </div><!-- /.item-no -->
        ...
        <div class="col-md-3 col-sm-6">
          <div class="item media wow animated fadeInLeft" data-wow-delay=".55s">
            <div class="section-padding">
              <div class="item-no media-left">
                <span class="count text-right">
                  <?php echo esc_html__( "02", "jeweltheme_polmo" ); ?>
                </span>
              </div><!-- /.item-no -->
              <div class="item-details media-body text-center">
                <div class="item-icon">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="item media wow animated fadeInLeft" data-wow-delay=".75s">
            <div class="section-padding">
              <div class="item-no media-left">
                <span class="count text-right">
                  <?php echo esc_html__( "03", "jeweltheme_polmo" ); ?>
                </span>
              </div><!-- /.item-no -->
              <div class="item-details media-body text-center">
                <div class="item-icon">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="item media wow animated fadeInLeft" data-wow-delay=".95s">
            <div class="section-padding">
              <div class="item-no media-left">
                <span class="count text-right">
                  <?php echo esc_html__( "04", "jeweltheme_polmo" ); ?>
                </span>
              </div><!-- /.item-no -->
              <div class="item-details media-body text-center">
                <div class="item-icon">
